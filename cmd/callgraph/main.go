...
package main // import "github.com/howardjohn/golang-tools/cmd/callgraph"
...
import (
	...
	"github.com/howardjohn/golang-tools/go/callgraph/cha"
	"github.com/howardjohn/golang-tools/go/callgraph/rta"
	"github.com/howardjohn/golang-tools/go/callgraph/static"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/howardjohn/golang-tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/howardjohn/golang-tools/cmd/callgraph |
      digraph succs github.com/howardjohn/golang-tools/cmd/callgraph.main
`
