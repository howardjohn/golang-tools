...
const this = "github.com/howardjohn/golang-tools/refactor/importgraph"

func TestBuild(t *testing.T) {
	exported := packagestest.Export(t, packagestest.GOPATH, []packagestest.Module{
		{Name: "github.com/howardjohn/golang-tools/refactor/importgraph", Files: packagestest.MustCopyFileTree(".")}})
