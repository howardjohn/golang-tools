...
// Options is github.com/howardjohn/golang-tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/howardjohn/golang-tools/imports.Process with explicit context in opt.Env.
