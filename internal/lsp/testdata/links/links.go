...
import (
	...
	"github.com/howardjohn/golang-tools/internal/lsp/foo" //@link(`github.com/howardjohn/golang-tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/howardjohn/golang-tools/internal/lsp/foo`)
