...
import (
	...
	"github.com/howardjohn/golang-tools/internal/lsp/baz"
	_ "github.com/howardjohn/golang-tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)
