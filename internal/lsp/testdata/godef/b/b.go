...
import (
	myFoo "github.com/howardjohn/golang-tools/internal/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"github.com/howardjohn/golang-tools/internal/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
