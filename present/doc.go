...
which can be slide presentations as in github.com/howardjohn/golang-tools/cmd/present
...
*/
package present // import "github.com/howardjohn/golang-tools/present"
