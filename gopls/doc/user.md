...
```sh
go get github.com/howardjohn/golang-tools/gopls@latest
```
...
```sh
go get github.com/howardjohn/golang-tools/gopls@vX.Y.Z
```
...
```sh
GO111MODULE=on go get github.com/howardjohn/golang-tools/gopls@latest
```
...
```sh
go get github.com/howardjohn/golang-tools/gopls@master github.com/howardjohn/golang-tools@master
```
